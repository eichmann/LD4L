...
public class PersonIndexer extends ThreadedIndexer implements Runnable {
	...
	String query =
		...
		"  ?uri <http://rdvocab.info/ElementsGr2/nameOfThePerson> ?subject . "+
		"}";
	queue(query);
	instantiateWriter();
    ...
    public PersonIndexer(int threadID) {
	logger.info("PersonIndexer thread: " + threadID);
