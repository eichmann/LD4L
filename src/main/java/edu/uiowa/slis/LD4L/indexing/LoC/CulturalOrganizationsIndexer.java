...
public class CulturalOrganizationsIndexer extends ThreadedIndexer implements Runnable {
    static boolean deprecated = false;

    public static void main(String[] args) throws Exception {
	PropertyConfigurator.configure("log4j.info");
	loadProperties("loc_cultural_organizations");
    ...
    public CulturalOrganizationsIndexer(int threadID) {
